...
const RegisterSucess = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative">
      ...
      {/* Centered glass card with frosted effect */}
      <div className="relative z-10 w-full max-w-5xl mx-auto my-auto flex flex-col items-center justify-center rounded-[36px] overflow-hidden shadow-xl" style={{minHeight: '60vh'}}>
        {/* Frosted overlay */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full py-12 px-4">
          ...
          <div className="text-[48px] font-bold text-blue-600 mb-4 text-center">Account Created Successfull</div>
          <div className="text-[24px] font-medium text-gray-800 mb-8 text-center">Please Check Your Email</div>
          <button
            className="bg-[#2056F6] text-white text-[32px] font-bold rounded-xl px-16 py-5 shadow hover:bg-[#003bb3] transition mb-2"
