...
export default function Layout({ role, title, subtitle, children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main
        className={`flex-1 flex flex-col min-h-screen overflow-auto transition-all duration-300 ${sidebarOpen ? 'lg:ml-72 xl:ml-80' : 'ml-0'}`}
      >
        <Header
          title={title}
          subtitle={subtitle}
        ...
        <div
          ...
          } w-full flex-1 pt-3 pb-6 lg:pb-8`}
        >
          {children}
        </div>
      </main>
